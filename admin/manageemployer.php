            ...
            <td>
              <table width="100%" border="1" bordercolor="black">
                <tr style="color:#fff">
                  ...
                  <th bgcolor="black">
                    <div align="left">Contact Person</div>
                  </th>
                  <th bgcolor="black">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <div align="left"><strong><a href="DetailEmp.php?EmpId=<?php echo $Id; ?>">Detail</a></strong>
                      </div>
                    </td>
                  </tr>
                <?php
                ...
                <tr>
                  <td colspan="4">
                    <div align="left"><?php echo "Total " . $records . " Records"; ?> </div>
                  </td>
                </tr>
                <?php
